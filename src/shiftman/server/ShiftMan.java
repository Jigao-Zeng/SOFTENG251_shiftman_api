...
public interface ShiftMan {
	 ...
	 * @param shopName The name of the shop the ros
	 * 
	 * ter is for.
	 ...
	 * @throws Exception 
	 */
	public String addShift(String dayOfWeek, String startTime, String endTime, String minimumWorkers) throws Exception;
	 ...
	 * @throws Exception 
	 */
	public String registerStaff(String givenname, String familyName) throws Exception;
